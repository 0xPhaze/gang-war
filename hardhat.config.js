...
const networks = ["mainnet", "rinkeby", "kovan", "goerli", "polygon", "mumbai", "avalanche", "fuji", "bsc", "bsctest"];
...
const etherscanApiKey = ["mainnet", "rinkeby", "kovan", "goerli"].includes(networkName)
