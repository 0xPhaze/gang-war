...
# 2: Simulate
source .env && US_DRY_RUN=true forge script detachRoot --rpc-url $RPC_MUMBAI --private-key $PRIVATE_KEY --with-gas-price 11gwei -vvvv --ffi

# 3: Deploy
source .env && forge script detachRoot --rpc-url $RPC_MUMBAI --private-key $PRIVATE_KEY --verify --etherscan-api-key $POLYGONSCAN_KEY --with-gas-price 11gwei -vvvv --ffi --broadcast 
